 ...
 * with no equality between parameters. This models the general case of checking if one parameter is greater than another.
 * 
 * @author Khalil Fazal
 * @student_number 100425046
 */
public class GT extends BooleanOperation {
    ...
    /**
     * Replace the value which new parameters will be compared with if there is an increasing change in value.
     * 
    ...
    public void apply(final Rational parameter) {
        ...
        if (this.comparator.isGreaterThan(parameter)) {
